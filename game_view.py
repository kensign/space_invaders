...
from enemy.enemy_invader import EnemyInvader
...
class GameView(arcade.View):
    ...
    def __init__(self):
        ...
        # Enemy movement
        self.enemy_change_x = -EnemyInvader.ENEMY_SPEED
    ...
    def setup_level_one(self):
        ...
        for column in range(column_count):
            ...
            for row in range(row_count):
                ...
                if row == 0 or row == 1:
                    texture1 = arcade.load_texture("assets/images/sprite_05.png")
                    texture2 = arcade.load_texture("assets/images/sprite_06.png")
                    score = 10
                elif row == 2 or row == 3:
                    texture1 = arcade.load_texture("assets/images/sprite_01.png")
                    texture2 = arcade.load_texture("assets/images/sprite_02.png")
                    score = 20
                else:
                    texture1 = arcade.load_texture("assets/images/sprite_03.png")
                    texture2 = arcade.load_texture("assets/images/sprite_04.png")
                    score = 30

                # Create the enemy instance
                # enemy image from kenney.nl
                enemy = EnemyInvader(texture1, texture2, self.loop)
                enemy.score = score
    ...
    def setup(self):
        ...
        self.player_sprite = Player("assets/images/player.png",
    ...
    def update_enemies(self):
        ...
        if move_down:
            ...
            for enemy in self.enemy_list:
                # Move enemy down
                enemy.center_y -= EnemyInvader.ENEMY_MOVE_DOWN_AMOUNT
    ...
    def allow_enemies_to_fire(self):
        ...
        for enemy in self.enemy_list:
            ...
            if random.randrange(chance) == 0 and enemy.center_x not in x_spawn:
                ...
                bullet.change_y = -EnemyInvader.BULLET_SPEED
    ...
    def fire_player_bullets(self):
        ...
        if len(self.player_bullet_list) < MAX_PLAYER_BULLETS:
            ...
            # Create a bullet
            bullet = arcade.Sprite("assets/images/player_bullet.png", SPRITE_SCALING_LASER)
            bullet.color = Player.PLAYER_COLOR

            # Give the bullet a speed
            bullet.change_y = Player.PLAYER_BULLET_SPEED
    ...
    def on_show_view(self):
        ...
        threading.Thread(target=run_async_loop, args=(self.loop,)).start()
        self.setup()